...
* @returns {Map<any, any>}
*/
export function solve_intermediate_witness(circuit, initial_witness) {
    const ret = wasm.solve_intermediate_witness(addHeapObject(circuit), addHeapObject(initial_witness));
